#!/usr/bin/env python3
"""Generate Dapr client helper functions for state management and pub/sub."""
...
def main():
    ...
    output_path = os.path.join(output_dir, "dapr_client.py")
    with open(output_path, 'w') as f:
        f.write(DAPR_HELPERS_CODE)

    print(f"✓ Generated Dapr client helpers: {output_path}")
